 ...
 *
 * Two slots are mode-aware; only their titles change here, never their icons:
 *  - "more"     → Pet Owners Store (owner) / "More" utilities hub (vet) — see `StoreTabScreen`
...
export default function TabsLayout() {
  ...
  return (
    <Tabs tabBar={(props) => <BottomTabBar {...props} />} screenOptions={{ headerShown: false }}>
      ...
      <Tabs.Screen
        name="more"
        options={{ title: isVeterinarianMode ? t('tabs.more') : t('tabs.store') }}
      />
      <Tabs.Screen
        name="services"
