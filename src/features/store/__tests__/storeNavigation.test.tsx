...
describe('Phase 10 store navigation + capability gates + Pet Owner coexistence', () => {
  ...
  const listProducts = jest.spyOn(productsApi, 'list');
  ...
  it('route builders are deep-link-safe absolute paths', () => {
    expect(Routes.organizationProducts('o1')).toBe('/(app)/organizations/o1/products');
    expect(Routes.organizationProductCreate('o1')).toBe('/(app)/organizations/o1/products/create');
    expect(Routes.organizationProduct('o1', 'p1')).toBe('/(app)/organizations/o1/products/p1');
    expect(Routes.organizationProductEdit('o1', 'p1')).toBe(
      '/(app)/organizations/o1/products/p1/edit',
    );
  });
  ...
  it('a VETERINARY_STORE dashboard shows the Products entry and navigates to it', async () => {
    ...
    expect(routerMock.push).toHaveBeenCalledWith('/(app)/organizations/o1/products');
  });
