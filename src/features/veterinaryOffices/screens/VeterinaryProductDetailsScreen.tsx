...
import { productTypeIcon, type Product } from '@/features/store';
import { useTheme } from '@/theme';

import { useVeterinaryOfficeProduct } from '../hooks';
...
export default function VeterinaryProductDetailsScreen() {
  ...
  const q = useVeterinaryOfficeProduct(officeId, productId);
    ...
    <ScrollScreen padded={false}>
      <View>
        {images.length > 0 ? (
          ...
          >
            <Icon name={productTypeIcon(product.productType)} size="iconXl" color="primary" />
          </View>
        )}
