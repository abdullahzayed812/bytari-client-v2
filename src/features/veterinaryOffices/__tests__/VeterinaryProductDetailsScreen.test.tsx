...
import VeterinaryProductDetailsScreen from '../screens/VeterinaryProductDetailsScreen';
...
describe('VeterinaryProductDetailsScreen', () => {
  const getProduct = jest.spyOn(veterinaryOfficeProductsApi, 'get');
  ...
  it('renders the product: name, price, description, detail fields and highlights', async () => {
    ...
    renderWithProviders(<VeterinaryProductDetailsScreen />);
