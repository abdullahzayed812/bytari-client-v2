...
import { useVeterinarianStore } from '../hooks';
...
/**
 * Veterinarian Store app bar — brand paw badge, title/subtitle, and a cart pill
...
export function StoreHeader({ title, subtitle, showBack }: StoreHeaderProps) {
  ...
  const { itemCount } = useVeterinarianStore();
  ...
  return (
    ...
    >
      ...
      <Pressable
        ...
        onPress={() => router.push(Routes.veterinarianStoreCart)}
        style={{
          flexDirection: 'row',
          alignItems: 'center',
