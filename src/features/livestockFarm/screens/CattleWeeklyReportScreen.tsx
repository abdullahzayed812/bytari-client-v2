...
import { useCattleBatches, useCattleWeeklySummary } from '../hooks';
...
/** Route `/(app)/livestock/cattle/[organizationId]/sections/weekly`. Mirrors `SheepWeeklyReportScreen`. */
export default function CattleWeeklyReportScreen() {
  ...
  const weekly = useCattleWeeklySummary(orgId, batch?.id, weekOf, { enabled: Boolean(batch) });
