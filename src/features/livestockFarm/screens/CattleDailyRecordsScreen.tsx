...
import { useCattleBatches, useCattleDailyRecords, useCreateCattleDailyRecord } from '../hooks';

/** Route `/(app)/livestock/cattle/[organizationId]/sections/daily` — البيانات اليومية. Mirrors `SheepDailyRecordsScreen`. */
