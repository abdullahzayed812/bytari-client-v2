...
import { useCattleBatch, useDeleteCattleBatch, useUpdateCattleBatch } from '../hooks';

/** Route `/(app)/livestock/cattle/[organizationId]/batches/[batchId]`. Mirrors `SheepBatchDetailScreen`. */
export default function CattleBatchDetailScreen() {
        ...
        <>
          ...
          <Section spacing="xl">
            ...
            <Card variant="outlined">
              ...
              <Divider spacing="sm" />
              <Field label={t('batchForm.fieldCalfCount')} value={String(batch.calfCount ?? 0)} />
              <Divider spacing="sm" />
              <Field label={t('batchForm.fieldBullCount')} value={String(batch.bullCount ?? 0)} />
              <Divider spacing="sm" />
