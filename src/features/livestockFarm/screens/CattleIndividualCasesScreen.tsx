...
import { useCattleBatches, useCattleCases, useCreateCattleCase } from '../hooks';

/** Route `/(app)/livestock/cattle/[organizationId]/sections/cases`. Mirrors `SheepIndividualCasesScreen`. */
export default function CattleIndividualCasesScreen() {
  ...
  const cases = useCattleCases(orgId, batch?.id, { pageSize: 100 }, { enabled: Boolean(batch) });
