...
import { useCreateSheepHealthEvent, useSheepBatches, useSheepHealthEvents } from '../hooks';
import { LIVESTOCK_HEALTH_EVENT_KINDS } from '../types';
import type { LivestockHealthEventKind } from '../types';

/** Route `/(app)/livestock/sheep/[organizationId]/sections/treatments` — العلاجات واللقاحات. Mirrors `TreatmentsScreen`. */
export default function SheepTreatmentsScreen() {
