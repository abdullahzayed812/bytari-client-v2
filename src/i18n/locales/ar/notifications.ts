export default {
   ...
   * Per-type copy, keyed by the backend `NotificationType`. Mirrors
   * `server/src/modules/notifications/domain/notification.copy.ts` (the server
   * stores/pushes Arabic); used when the app language is NOT Arabic — see
   * `localizedNotificationText`.
   */,
  types: {
    ACCOUNT_STATUS_CHANGED: {
      title: 'تحديث حالة الحساب',
      body: 'تم تحديث حالة حسابك.',
    },
    ...
    ORGANIZATION_APPROVED: {
      title: 'تمت الموافقة على منشأتك',
      body: 'تمت الموافقة على منشأتك.',
    },
    ...
    ORGANIZATION_SUSPENDED: {
      ...
      body: 'تم تعليق منشأتك.',
    },
    ORGANIZATION_ACTIVATED: {
      title: 'تمت إعادة تفعيل منشأتك',
      body: 'تمت إعادة تفعيل منشأتك.',
    },
    ORGANIZATION_DEACTIVATED: {
      title: 'تم إيقاف منشأتك',
      body: 'تم إيقاف منشأتك.',
    },
    ORGANIZATION_MEMBER_ADDED: {
      title: 'تمت إضافتك إلى منشأة',
      body: 'تمت إضافتك عضوًا في منشأة.',
    },
    ...
    SUBSCRIPTION_UPDATED: {
      ...
      body: 'تم تحديث فترة اشتراك منشأتك.',
    },
    ...
    FARM_MEMBER_JOINED: {
      title: 'عضو جديد في الحقل',
      body: 'انضم عضو جديد إلى حقلك.',
    },
    FARM_APPOINTMENT_CREATED: {
      title: 'موعد جديد',
      body: 'تمت إضافة موعد جديد في الحقل.',
    },
    ...
    TRADER_REJECTED: {
      title: 'لم تتم الموافقة على طلب التاجر',
      body: 'تم رفض طلب تسجيلك كتاجر.',
    },
    TRADER_SUSPENDED: {
      title: 'تم تعليق حساب التاجر',
      body: 'تم تعليق حسابك كتاجر.',
    },
    TRADER_REACTIVATED: {
    ...
    SYSTEM_SUPERVISOR_ASSIGNED: {
      title: 'تعيين مشرف',
      body: 'تم تعيينك مشرفًا في النظام.',
    },
    ...
    CONSULTATION_CLOSED: {
      ...
      body: 'تم إغلاق استشارتك.',
    },
    INQUIRY_CREATED: {
      title: 'استفسار جديد',
      body: 'تم تقديم استفسار جديد.',
    },
    INQUIRY_MESSAGE_RECEIVED: {
      title: 'رد جديد على استفسار',
      body: 'هناك رسالة جديدة في استفسار.',
    },
    INQUIRY_CLOSED: {
      title: 'تم إغلاق الاستفسار',
      body: 'تم إغلاق استفسارك.',
    },
    SUPPORT_CREATED: {
      title: 'رسالة دعم جديدة',
      body: 'تم إرسال رسالة دعم جديدة.',
    },
    SUPPORT_MESSAGE_RECEIVED: {
      title: 'رد جديد من الدعم',
      body: 'هناك رسالة جديدة في طلب الدعم.',
    },
    SUPPORT_CLOSED: {
      title: 'تم إغلاق طلب الدعم',
      body: 'تم إغلاق طلب الدعم الخاص بك.',
    },
    ...
    VET_SERVICE_OFFER_ACCEPTED: {
      title: 'تم قبول عرضك',
      body: 'تم قبول عرضك وفتح محادثة.',
    },
    VET_SERVICE_OFFER_REJECTED: {
      title: 'لم يتم قبول عرضك',
      body: 'اختار صاحب الطلب عرضًا آخر.',
    },
    ...
    VET_COURSE_CANCELLED: {
      title: 'تم الإلغاء',
      body: 'تم إلغاء دورة أو ندوة سجّلت فيها.',
    },
    ...
    VET_JOB_APPLICATION_RECEIVED: {
      ...
      body: 'تقدّم أحدهم لوظيفتك.',
    },
    VET_JOB_APPLICATION_ACCEPTED: {
      title: 'تم قبول طلبك',
      body: 'تم قبول طلب التوظيف وفتح محادثة.',
    },
    VET_JOB_APPLICATION_REJECTED: {
      title: 'لم يتم قبول طلبك',
      body: 'تم رفض طلب التوظيف.',
    },
    STORE_ORDER_PLACED: {
      title: 'طلب شراء جديد',
      body: 'تم استلام طلب شراء جديد.',
    },
    ...
    PUBLICATION_APPROVED: {
      ...
      body: 'أصبح منشورك ظاهرًا للجميع.',
    },
    ...
    TRANSFER_REQUEST_ACCEPTED: {
      title: 'تم قبول نقل الملكية',
      body: 'تم قبول طلب نقل الملكية.',
    },
    TRANSFER_REQUEST_REJECTED: {
      title: 'تم رفض نقل الملكية',
      body: 'تم رفض طلب نقل الملكية.',
    },
    CLINIC_APPOINTMENT_REQUESTED: {
      title: 'طلب موعد جديد',
      body: 'طلب أحد المربين موعدًا.',
    },
    ...
    CLINIC_APPOINTMENT_REJECTED: {
      title: 'تم رفض الموعد',
      body: 'اعتذرت العيادة عن طلب الموعد.',
    },
